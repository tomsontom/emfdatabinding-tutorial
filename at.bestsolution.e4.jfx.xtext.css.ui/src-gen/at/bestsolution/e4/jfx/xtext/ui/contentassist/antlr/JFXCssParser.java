		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFontValueAccess().getStyleOrWeightAlternatives_0_0(), "rule__FontValue__StyleOrWeightAlternatives_0_0");
					put(grammarAccess.getFontStyleValueAccess().getValueAlternatives_0(), "rule__FontStyleValue__ValueAlternatives_0");
					put(grammarAccess.getFontWeightValueAccess().getValueAlternatives_0(), "rule__FontWeightValue__ValueAlternatives_0");
					...
					put(grammarAccess.getFontValueAccess().getStyleOrWeightAssignment_0(), "rule__FontValue__StyleOrWeightAssignment_0");
					...
					put(grammarAccess.getFontWeightValueAccess().getValueAssignment(), "rule__FontWeightValue__ValueAssignment");
