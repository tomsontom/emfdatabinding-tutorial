		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMultiPaintPropertiesAccess().getAlternatives_2(), "rule__MultiPaintProperties__Alternatives_2");
					put(grammarAccess.getColorPropertyKeysAccess().getAlternatives(), "rule__ColorPropertyKeys__Alternatives");
					put(grammarAccess.getStringPropertyAccess().getPropertyAlternatives_0_0(), "rule__StringProperty__PropertyAlternatives_0_0");
					put(grammarAccess.getStringPropertyAccess().getAlternatives_2(), "rule__StringProperty__Alternatives_2");
					put(grammarAccess.getPositionPropertyAccess().getPropertyAlternatives_0_0(), "rule__PositionProperty__PropertyAlternatives_0_0");
					put(grammarAccess.getAlignmentPropertyAccess().getPropertyAlternatives_0_0(), "rule__AlignmentProperty__PropertyAlternatives_0_0");
					...
					put(grammarAccess.getMultiPaintPropertiesAccess().getGroup(), "rule__MultiPaintProperties__Group__0");
					put(grammarAccess.getMultiPaintPropertiesAccess().getGroup_2_0(), "rule__MultiPaintProperties__Group_2_0__0");
					put(grammarAccess.getMultiPaintPropertiesAccess().getGroup_2_0_1(), "rule__MultiPaintProperties__Group_2_0_1__0");
					...
					put(grammarAccess.getPositionPropertyAccess().getGroup(), "rule__PositionProperty__Group__0");
					put(grammarAccess.getPositionPropertyAccess().getGroup_3(), "rule__PositionProperty__Group_3__0");
					...
					put(grammarAccess.getMultiPaintPropertiesAccess().getPropertyAssignment_0(), "rule__MultiPaintProperties__PropertyAssignment_0");
					put(grammarAccess.getMultiPaintPropertiesAccess().getValuesAssignment_2_0_0(), "rule__MultiPaintProperties__ValuesAssignment_2_0_0");
					put(grammarAccess.getMultiPaintPropertiesAccess().getValuesAssignment_2_0_1_1(), "rule__MultiPaintProperties__ValuesAssignment_2_0_1_1");
					...
					put(grammarAccess.getStringPropertyAccess().getPropertyAssignment_0(), "rule__StringProperty__PropertyAssignment_0");
					put(grammarAccess.getStringPropertyAccess().getValueAssignment_2_0(), "rule__StringProperty__ValueAssignment_2_0");
					put(grammarAccess.getPositionPropertyAccess().getPropertyAssignment_0(), "rule__PositionProperty__PropertyAssignment_0");
					put(grammarAccess.getPositionPropertyAccess().getValuesAssignment_2(), "rule__PositionProperty__ValuesAssignment_2");
					put(grammarAccess.getPositionPropertyAccess().getValuesAssignment_3_1(), "rule__PositionProperty__ValuesAssignment_3_1");
