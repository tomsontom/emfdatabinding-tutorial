...
public class PersonForm extends JPanel
{
  ...
  public PersonForm()
  {
    ...
    privateAddressForm.setBorder(new TitledBorder(null, "Private", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    add(privateAddressForm, "cell 0 2 2 1,grow");

    JPanel panel = new JPanel();
    panel.setBorder(new TitledBorder(null, "Business", TitledBorder.LEADING, TitledBorder.TOP, null, null));
  ...
  private void bindControls()
  {
    ...
    {
      IEMFValueProperty mProp = EMFProperties.list(AddressbookPackage.Literals.PERSON__ADDRESSES).value(
