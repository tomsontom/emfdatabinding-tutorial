 ...
 * <ul>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getStreet <em>Street</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getZip <em>Zip</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getCity <em>City</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getFederalState <em>Federal State</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getType <em>Type</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressImpl#getPerson <em>Person</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressImpl extends EObjectImpl implements Address
{
  ...
  /**
	 * The cached value of the '{@link #getFederalState() <em>Federal State</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #getFederalState()
	 * @generated
  ...
  public Country getCountry()
  {
		if (country != null && country.eIsProxy()) {
			...
			if (country != oldCountry) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AddressbookPackage.ADDRESS__COUNTRY, oldCountry, country));
			}
		}
		return country;
	}
  ...
  public FederalState getFederalState()
  {
		if (federalState != null && federalState.eIsProxy()) {
			...
			if (federalState != oldFederalState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AddressbookPackage.ADDRESS__FEDERAL_STATE, oldFederalState, federalState));
			}
		}
		return federalState;
	}
  ...
  public void setFederalState(FederalState newFederalState)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.ADDRESS__FEDERAL_STATE, oldFederalState, federalState));
	}
  ...
  public void setType(AddressType newType)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.ADDRESS__TYPE, oldType, type));
	}
  ...
  /**
	...
	public Person getPerson() {
		if (eContainerFeatureID() != AddressbookPackage.ADDRESS__PERSON) return null;
	...
	public NotificationChain basicSetPerson(Person newPerson, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPerson, AddressbookPackage.ADDRESS__PERSON, msgs);
		return msgs;
	}
	...
	public void setPerson(Person newPerson) {
		if (newPerson != eInternalContainer() || (eContainerFeatureID() != AddressbookPackage.ADDRESS__PERSON && newPerson != null)) {
			...
			if (newPerson != null)
				msgs = ((InternalEObject)newPerson).eInverseAdd(this, AddressbookPackage.PERSON__ADDRESSES, Person.class, msgs);
			msgs = basicSetPerson(newPerson, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.ADDRESS__PERSON, newPerson, newPerson));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AddressbookPackage.ADDRESS__PERSON:
				return eInternalContainer().eInverseRemove(this, AddressbookPackage.PERSON__ADDRESSES, Person.class, msgs);
		}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			...
			case AddressbookPackage.ADDRESS__FEDERAL_STATE:
				if (resolve) return getFederalState();
