 ...
 * $Id$
 */
package at.bestsolution.e4.addressbook.model.addressbook.util;

import at.bestsolution.e4.addressbook.model.addressbook.*;
...
public class AddressbookAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AddressbookSwitch<Adapter> modelSwitch =
    new AddressbookSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFederalState(FederalState object) {
				return createFederalStateAdapter();
			}
			@Override
  ...
  /**
	 * Creates a new adapter for an object of class '{@link at.bestsolution.e4.addressbook.model.addressbook.AddressBook <em>Address Book</em>}'.
	 * <!-- begin-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link at.bestsolution.e4.addressbook.model.addressbook.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link at.bestsolution.e4.addressbook.model.addressbook.Address <em>Address</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link at.bestsolution.e4.addressbook.model.addressbook.Country <em>Country</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link at.bestsolution.e4.addressbook.model.addressbook.FederalState <em>Federal State</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public Adapter createFederalStateAdapter()
  {
		return null;
	}
