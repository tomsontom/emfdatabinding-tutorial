...
public class AddressbookFactoryImpl extends EFactoryImpl implements AddressbookFactory
{
  ...
  {
		try {
			AddressbookFactory theAddressbookFactory = (AddressbookFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/example"); 
  ...
  public EObject create(EClass eClass)
  {
		switch (eClass.getClassifierID()) {
			...
			case AddressbookPackage.COUNTRY: return createCountry();
			case AddressbookPackage.FEDERAL_STATE: return createFederalState();
			default:
