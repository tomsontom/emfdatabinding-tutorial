...
public interface AddressbookFactory extends EFactory {
	 ...
	 * @generated
	 */
	AddressbookFactory eINSTANCE = at.bestsolution.e4.addressbook.model.addressbook.impl.AddressbookFactoryImpl
			.init();
	...
	/**
	 * Returns a new object of class '<em>Country</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
