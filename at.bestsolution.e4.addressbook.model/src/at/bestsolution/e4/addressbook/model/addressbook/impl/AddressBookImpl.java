 ...
 * <ul>
 * <li>
 * {@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressBookImpl#getPersons
 * <em>Persons</em>}</li>
 * <li>
 * {@link at.bestsolution.e4.addressbook.model.addressbook.impl.AddressBookImpl#getCountries
 * <em>Countries</em>}</li>
 * </ul>
 * </p>
 * 
...
public class AddressBookImpl extends EObjectImpl implements AddressBook {
	/**
	 * The cached value of the '{@link #getPersons() <em>Persons</em>}'
	...
	/**
	 * The cached value of the '{@link #getCountries() <em>Countries</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCountries()
	 * @generated
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentWithInverseEList<Person>(
					Person.class, this,
					AddressbookPackage.ADDRESS_BOOK__PERSONS,
					AddressbookPackage.PERSON__ADDRESS_BOOK);
		}
		return persons;
	}
	...
	public EList<Country> getCountries() {
		if (countries == null) {
			countries = new EObjectContainmentEList<Country>(Country.class,
					this, AddressbookPackage.ADDRESS_BOOK__COUNTRIES);
		}
		return countries;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case AddressbookPackage.ADDRESS_BOOK__PERSONS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getPersons())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case AddressbookPackage.ADDRESS_BOOK__PERSONS:
			return ((InternalEList<?>) getPersons())
					.basicRemove(otherEnd, msgs);
		case AddressbookPackage.ADDRESS_BOOK__COUNTRIES:
			return ((InternalEList<?>) getCountries()).basicRemove(otherEnd,
					msgs);
		}
