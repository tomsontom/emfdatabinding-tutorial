 ...
 * <ul>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.CountryImpl#getFederalStates <em>Federal States</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.CountryImpl#getName <em>Name</em>}</li>
 *   <li>{@link at.bestsolution.e4.addressbook.model.addressbook.impl.CountryImpl#getAddressBook <em>Address Book</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{
  /**
	 * The cached value of the '{@link #getFederalStates() <em>Federal States</em>}' containment reference list.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * The cached value of the '{@link #getAddressBook() <em>Address Book</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAddressBook()
	 * @generated
  ...
  public EList<FederalState> getFederalStates()
  {
		if (federalStates == null) {
			federalStates = new EObjectContainmentWithInverseEList<FederalState>(FederalState.class, this, AddressbookPackage.COUNTRY__FEDERAL_STATES, AddressbookPackage.FEDERAL_STATE__COUNTRY);
		}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.COUNTRY__NAME, oldName, name));
	}
  ...
  /**
	...
	public AddressBook getAddressBook() {
		if (addressBook != null && addressBook.eIsProxy()) {
			...
			if (addressBook != oldAddressBook) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AddressbookPackage.COUNTRY__ADDRESS_BOOK, oldAddressBook, addressBook));
			}
		}
		return addressBook;
	}
	...
	public void setAddressBook(AddressBook newAddressBook) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.COUNTRY__ADDRESS_BOOK, oldAddressBook, addressBook));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AddressbookPackage.COUNTRY__FEDERAL_STATES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFederalStates()).basicAdd(otherEnd, msgs);
		}
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
		switch (featureID) {
			case AddressbookPackage.COUNTRY__FEDERAL_STATES:
				return ((InternalEList<?>)getFederalStates()).basicRemove(otherEnd, msgs);
		}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			...
			case AddressbookPackage.COUNTRY__ADDRESS_BOOK:
				if (resolve) return getAddressBook();
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			case AddressbookPackage.COUNTRY__FEDERAL_STATES:
				...
				getFederalStates().addAll((Collection<? extends FederalState>)newValue);
				return;
			case AddressbookPackage.COUNTRY__NAME:
