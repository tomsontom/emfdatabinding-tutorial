...
public class AddressbookSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AddressbookPackage.FEDERAL_STATE: {
			FederalState federalState = (FederalState) theEObject;
			T result = caseFederalState(federalState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Country</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Federal State</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	 ...
	 * @generated
	 */
	public T caseFederalState(FederalState object) {
		return null;
	}
