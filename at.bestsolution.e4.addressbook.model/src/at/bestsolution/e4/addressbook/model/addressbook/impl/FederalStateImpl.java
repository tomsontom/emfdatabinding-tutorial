 ...
 * <em><b>Federal State</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link at.bestsolution.e4.addressbook.model.addressbook.impl.FederalStateImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link at.bestsolution.e4.addressbook.model.addressbook.impl.FederalStateImpl#getCountry
 * <em>Country</em>}</li>
 * </ul>
 * </p>
 * 
...
public class FederalStateImpl extends EObjectImpl implements FederalState {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AddressbookPackage.FEDERAL_STATE__NAME, oldName, name));
	}
	...
	public Country getCountry() {
		if (eContainerFeatureID() != AddressbookPackage.FEDERAL_STATE__COUNTRY)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCountry(Country newCountry,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newCountry,
				AddressbookPackage.FEDERAL_STATE__COUNTRY, msgs);
		return msgs;
	}
	...
	public void setCountry(Country newCountry) {
		if (newCountry != eInternalContainer()
				|| (eContainerFeatureID() != AddressbookPackage.FEDERAL_STATE__COUNTRY && newCountry != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AddressbookPackage.FEDERAL_STATE__COUNTRY, newCountry,
					newCountry));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case AddressbookPackage.FEDERAL_STATE__COUNTRY:
			return eInternalContainer().eInverseRemove(this,
					AddressbookPackage.COUNTRY__FEDERAL_STATES, Country.class,
					msgs);
		}
