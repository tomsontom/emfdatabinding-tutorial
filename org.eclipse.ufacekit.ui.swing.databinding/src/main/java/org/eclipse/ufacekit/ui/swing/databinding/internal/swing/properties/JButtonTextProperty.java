 ...
 * 
 */
public class JButtonTextProperty extends WidgetStringValueProperty<EventType,JButton> {
	String doGetStringValue(Object source) {
		return ((JButton) source).getText();
	}

	void doSetStringValue(Object source, String value) {
		((JButton) source).setText(value == null ? "" : value); //$NON-NLS-1$
	}
	...
	@Override
	protected IDelegateRegistration registerDelegate(EventType type, JButton widget, Delegate delegate) {
		return null;
	}
}
